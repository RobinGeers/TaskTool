...
<main id="Instellingen_Extern">
    ...
    <section id="Toevoegen">
        ...
        <input type="text" name="Filter_Naam" id="Filter_Naam" placeholder="Naam lokaal" onkeyup="naamChange(this)"
               data-column="0"/>
        <i class="ui search icon"></i>
        <!-- <input type="text" name="Filter_Naam_Medewerker" id="Filter_Naam_Medewerker" placeholder="Naam medewerker.."/>-->
        <input type="text" name="Filter_email" id="Filter_email" placeholder="Omschrijving"
               onkeyup="omschrijvingChange(this)"
               data-column="1"/>
        <i class="ui search icon"></i>
