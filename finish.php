...
<div id="container" class="finishcontainer">
    <form>
        ...
        <label for="bericht" class="lbl">Voeg een opmerking toe (Enkel verplicht als de taak niet kan worden
            afgewerkt)</label><br/>
        <textarea cols="50" rows="10" id="BER" name="bericht" class="txtbericht"></textarea><br/>
        <input onclick="dosome(this)" type="button" id="versturen" name="versturen" class="btnverstuur"
               value="Verstuur"/>
    </form>
</div>
</body>
