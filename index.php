...
if (isset($_GET['error'])) {
    ...
    $errormessage = str_replace("1", " ", $errormessage);
}
...
<main id="LoginFormulier">
    ...
    <section id="Login">
        ...
        <form action="./Meld_Defect/index.php" method="POST" id="form">
            ...
            <input id="txtWachtwoord" type="Password" name="txtWachtwoord" placeholder="Wachtwoord" required
                   tabindex="2">
            ...
            <input type="submit" value="Login" name="btnLogin" id="btnLogin" tabindex="8" class="transitions"
                   onclick="doorsturen(event)">
        </form>
    </section>
</main>
<script>
