...
!function (e, t, n, i) {
    ...
    e.fn.form = function (t, o) {
        var a, r = e(this), s = e.extend(!0, {}, e.fn.form.settings, o), c = e.extend({}, e.fn.form.settings.defaults, t), l = s.namespace, u = s.metadata, d = s.selector, m = s.className, f = (s.error, "." + l), g = "module-" + l, p = r.selector || "", v = (new Date).getTime(), h = [], b = arguments[0], y = "string" == typeof b, x = [].slice.call(arguments, 1);
        return r.each(function () {
            ...
            t = {
                initialize: function () {
                    ...
                    l.each(function () {
                        var n = e(this), i = n.parent(), o = n.closest(w), a = o.find(d.prompt), r = n.data(u.defaultValue) || "", s = i.is(d.uiCheckbox), c = i.is(d.uiDropdown), l = o.hasClass(m.error);
                    ...
                    changeEvent: function (e) {
                        ...
                        return i.each(function (n, i) {
                            var a = e(i), r = (a.prop("type"), a.prop("name")), s = a.val(), c = a.is(d.checkbox), l = a.is(d.radio), u = -1 !== r.indexOf("[]"), m = c ? a.is(":checked") : !1;
                            if (r)if (u)if (r = r.replace("[]", ""), o[r] || (o[r] = []), c) {
                                if (!m)return t.debug("Omitted unchecked checkbox", a), !0;
                                o[r].push(s)
                            } else o[r].push(s); else if (l)m && (o[r] = s); else if (c) {
                                if (!m)return t.debug("Omitted unchecked checkbox", a), !0;
                                o[r] = !0
                            } else o[r] = s
                        }), o
                    ...
                    success: function () {
                        ...
                        e.isEmptyObject(n) || (e.each(n, function (n, i) {
                            var o, a = t.get.field(n), r = a.parent(), s = e.isArray(i), c = r.is(d.uiCheckbox), l = r.is(d.uiDropdown), u = a.is(d.radio) && c, m = a.length > 0;
                    ...
                    form: function (n) {
                        ...
                        var a, r, c = t.get.field(n.identifier), l = o.type, u = e.trim(c.val() + ""), d = /\[(.*)\]/i, m = d.exec(l), f = !0;
    ...
    e.fn.accordion = function (n) {
        ...
        return a.each(function () {
            var d, m, f = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.accordion.settings, n) : e.extend({}, e.fn.accordion.settings), g = f.className, p = f.namespace, v = f.selector, h = f.error, b = "." + p, y = "module-" + p, x = a.selector || "", w = e(this), C = w.find(v.title), T = w.find(v.content), k = this, S = w.data(y);
            m = {
                initialize: function () {
                    ...
                    }), d.observe(k, {childList: !0, subtree: !0}), m.debug("Setting up mutation observer", d))
                }, bind: {
                    events: function () {
                    ...
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(v.title) : e(this).closest(v.title), o = n.next(T), a = o.hasClass(g.animating), r = o.hasClass(g.active), s = r && !a, c = !r && a;
                    ...
                    var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(v.title) : e(this).closest(v.title), o = n.next(T), a = o.hasClass(g.animating), r = o.hasClass(g.active), s = !r && !a;
                    s && (m.debug("Opening accordion content", n), f.exclusive && m.closeOthers.call(n), n.addClass(g.active), o.addClass(g.animating), f.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        ...
                        verbose: f.verbose,
                        duration: f.duration
                    }) : o.children().stop(!0).animate({opacity: 1}, f.duration, m.resetOpacity)), o.stop(!0).slideDown(f.duration, f.easing, function () {
                    ...
                    !r && !s || c || (m.debug("Closing accordion content", o), n.removeClass(g.active), o.addClass(g.animating), f.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
                        ...
                        verbose: f.verbose,
                        duration: f.duration
                    }) : o.children().stop(!0).animate({opacity: 0}, f.duration, m.resetOpacity)), o.stop(!0).slideUp(f.duration, f.easing, function () {
                    ...
                    f.closeNested ? (n = c.find(l).not(s), a = n.next(T)) : (n = c.find(l).not(s), o = c.find(u).find(l).not(s), n = n.not(o), a = n.next(T)), n.length > 0 && (m.debug("Exclusive enabled, closing other content", n), n.removeClass(g.active), f.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? a.children().transition({
                        ...
                        verbose: f.verbose,
                        duration: f.duration
                    }) : a.children().stop().animate({opacity: 0}, f.duration, m.resetOpacity)), a.stop().slideUp(f.duration, f.easing, function () {
    ...
    e.fn.checkbox = function (n) {
        ...
        return a.each(function () {
            var a, m, f = e.extend(!0, {}, e.fn.checkbox.settings, n), g = f.className, p = f.namespace, v = f.selector, h = f.error, b = "." + p, y = "module-" + p, x = e(this), w = e(this).find(v.label).first(), C = e(this).find(v.input), T = x.data(y), k = this;
            m = {
                initialize: function () {
    ...
    e.fn.dimmer = function (t) {
        var o, a = e(this), r = (new Date).getTime(), s = [], c = arguments[0], l = "string" == typeof c, u = [].slice.call(arguments, 1);
        return a.each(function () {
            var d, m, f, g = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.dimmer.settings, t) : e.extend({}, e.fn.dimmer.settings), p = g.selector, v = g.namespace, h = g.className, b = g.error, y = "." + v, x = "module-" + v, w = a.selector || "", C = "ontouchstart"in n.documentElement ? "touchstart" : "click", T = e(this), k = this, S = T.data(x);
            f = {
                preinitialize: function () {
                    ...
                    }, f.debug("Showing dimmer", d, g), f.is.dimmed() && !f.is.animating() || !f.is.enabled() ? f.debug("Dimmer is already shown or disabled") : (f.animate.show(t), g.onShow.call(k), g.onChange.call(k))
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, f.is.dimmed() || f.is.animating() ? (f.debug("Hiding dimmer", d), f.animate.hide(t), g.onHide.call(k), g.onChange.call(k)) : f.debug("Dimmer is not visible")
                }, toggle: function () {
    ...
    e.fn.dropdown = function (o) {
        ...
        return r.each(function () {
            var p, v, h, b, y = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings), x = y.className, w = y.metadata, C = y.namespace, T = y.selector, k = y.error, S = "." + C, A = "module-" + C, P = e(this), E = P.find(T.text), F = P.find(T.search), R = P.find(T.input), O = P.prev().find(T.text).length > 0 ? P.prev().find(T.text) : P.prev(), D = P.children(T.menu), z = D.find(T.item), q = !1, j = !1, N = this, I = P.data(A);
            b = {
                initialize: function () {
                    ...
                    }), h.observe(N, {childList: !0, subtree: !0}), b.debug("Setting up mutation observer", h))
                }, create: {
                    id: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, b.is.searchSelection() && b.is.allFiltered() || b.can.show() && !b.is.active() && (b.debug("Showing dropdown"), b.animate.show(function () {
                        b.can.click() && b.bind.intent(), b.set.visible(), t.call(N)
                    }), y.onShow.call(N))
                }, hide: function (t) {
                    t = e.isFunction(t) ? t : function () {
                    }, b.is.active() && (b.debug("Hiding dropdown"), b.animate.hide(function () {
                    ...
                    var e = z.not(x.filtered).filter("." + x.selected).eq(0), t = z.filter("." + x.active).eq(0), n = e.length > 0 ? e : t, i = n.size() > 0;
                    ...
                    mousedown: function () {
                        ...
                        {
                            var t, n = z.not(x.filtered).filter("." + x.selected).eq(0), i = D.children("." + x.active).eq(0), o = n.length > 0 ? n : i, a = o.length > 0 ? o.siblings(":not(." + x.filtered + ")").andSelf() : D.children(":not(." + x.filtered + ")"), r = o.children(T.menu), s = o.closest(T.menu), c = s[0] !== D[0], l = s.is(":visible"), u = e.which, d = {
                                enter: 13,
                                escape: 27,
                                leftArrow: 37,
                                upArrow: 38,
                        ...
                        mouseenter: function (t) {
                            ...
                            var n = e(this), i = e(t ? t.target : ""), o = n.find(T.menu), a = b.get.choiceText(n), r = b.get.choiceValue(n, a), s = function () {
                    ...
                    selectAction: function (t, n) {
                        ...
                        }, 0 === e(t.target).closest(P).length ? (b.verbose("Triggering event", n), n(), !0) : (b.verbose("Event occurred in dropdown, canceling callback"), !1)
                    }, eventInMenu: function (t, n) {
                        return n = e.isFunction(n) ? n : function () {
                        }, 0 === e(t.target).closest(D).length ? (b.verbose("Triggering event", n), n(), !0) : (b.verbose("Event occurred in dropdown menu, canceling callback"), !1)
                    }
                }, action: {
                    nothing: function () {
                    ...
                    show: function (t, n) {
                        var o = n || D, a = n ? function () {
                        } : function () {
                            b.hideSubMenus(), b.hideOthers(), b.set.active()
                        };
                        t = e.isFunction(t) ? t : function () {
                        }, b.set.scrollPosition(b.get.activeItem(), !0), b.verbose("Doing menu show animation", o), (b.is.hidden(o) || b.is.animating(o)) && ("auto" == y.transition && (y.transition = b.is.upward() ? "slide up" : "slide down", b.verbose("Automatically determining animation based on animation direction", y.transition)), "none" == y.transition ? t.call(N) : e.fn.transition !== i && P.transition("is supported") ? o.transition({
                        ...
                        }) : "slide down" == y.transition ? (a(), o.hide().clearQueue().children().clearQueue().css("opacity", 0).delay(50).animate({opacity: 1}, y.duration, "easeOutQuad", b.event.resetStyle).end().slideDown(100, "easeOutQuad", function () {
                        ...
                        var o = n || D, a = (n ? .9 * y.duration : y.duration, n ? function () {
                        } : function () {
                            b.can.click() && b.unbind.intent(), b.focusSearch(), b.remove.active()
                        });
                        t = e.isFunction(t) ? t : function () {
                        }, (b.is.visible(o) || b.is.animating(o)) && (b.verbose("Doing menu hide animation", o), "auto" == y.transition && (y.transition = b.is.upward() ? "slide up" : "slide down"), R.trigger("blur"), "none" == y.transition ? t.call(N) : e.fn.transition !== i && P.transition("is supported") ? o.transition({
                        ...
                        }) : "slide down" == y.transition ? (a(), o.show().clearQueue().children().clearQueue().css("opacity", 1).animate({opacity: 0}, 100, "easeOutQuad", b.event.resetStyle).end().delay(50).slideUp(100, "easeOutQuad", function () {
                            b.event.resetStyle.call(this), t.call(N)
                    ...
                    if (b.debug("Changing setting", t, n), e.isPlainObject(t))e.extend(!0, y, t); else {
                        if (n === i)return y[t];
                        y[t] = n
                    }
                }, internal: function (t, n) {
    ...
    e.fn.modal = function (o) {
        ...
        return r.each(function () {
            var r, h, b, y, x, w, C, T, k, S = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings), A = S.selector, P = S.className, E = S.namespace, F = S.error, R = "." + E, O = "module-" + E, D = e(this), z = e(S.context), q = D.find(A.close), j = this, N = D.data(O);
            k = {
                initialize: function () {
                    ...
                    }), T.observe(j, {childList: !0, subtree: !0}), k.debug("Setting up mutation observer", T))
                }, refresh: function () {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, k.debug("Hiding modal"), S.onHide.call(j), (k.is.animating() || k.is.active()) && (S.transition && e.fn.transition !== i && D.transition("is supported") ? (k.remove.active(), D.transition({
                        debug: S.debug,
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, n.length > 0 && (k.debug("Hiding other modals", h), n.modal("hide modal", t, !0))
    ...
    e.fn.nag = function (n) {
        ...
        return a.each(function () {
            {
                var a, m = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.nag.settings, n) : e.extend({}, e.fn.nag.settings), f = (m.className, m.selector), g = m.error, p = m.namespace, v = "." + p, h = p + "-module", b = e(this), y = b.find(f.close), x = e(m.context ? m.context : "body"), w = this, C = b.data(h);
                t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function (e) {
                    setTimeout(e, 0)
                }
            }
    ...
    e.fn.popup = function (o) {
        var a, r = e(this), s = e(n), c = r.selector || "", l = "ontouchstart"in n.documentElement, u = (new Date).getTime(), d = [], m = arguments[0], f = "string" == typeof m, g = [].slice.call(arguments, 1);
        return r.each(function () {
            var n, r, p, v, h, b = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.popup.settings, o) : e.extend({}, e.fn.popup.settings), y = b.selector, x = b.className, w = b.error, C = b.metadata, T = b.namespace, k = "." + b.namespace, S = "module-" + T, A = e(this), P = e(b.context), E = b.target ? e(b.target) : A, F = e(t), R = e("body"), O = 0, D = !1, z = this, q = A.data(S);
            h = {
                initialize: function () {
    ...
    e.fn.progress = function (t) {
        var o, a = e(this), r = a.selector || "", s = (new Date).getTime(), c = [], l = arguments[0], u = "string" == typeof l, d = [].slice.call(arguments, 1);
        return a.each(function () {
            var a, m, f = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.progress.settings, t) : e.extend({}, e.fn.progress.settings), g = f.className, p = f.metadata, v = f.namespace, h = f.selector, b = f.error, y = "." + v, x = "module-" + v, w = e(this), C = e(this).find(h.bar), T = e(this).find(h.progress), k = e(this).find(h.label), S = this, A = w.data(x), P = !1;
            m = {
                initialize: function () {
                    ...
                    text: function (e) {
                        var t = m.value || 0, n = m.total || 0, i = m.is.visible() && P ? m.get.displayPercent() : m.percent || 0, o = m.total > 0 ? n - t : 100 - i;
                        ...
                        var e = C.width(), t = w.width(), n = parseInt(C.css("min-width"), 10), i = e > n ? e / t * 100 : m.percent;
    ...
    e.fn.rating = function (t) {
        ...
        return o.each(function () {
            var d, m = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.rating.settings, t) : e.extend({}, e.fn.rating.settings), f = m.namespace, g = m.className, p = m.metadata, v = m.selector, h = (m.error, "." + f), b = "module-" + f, y = this, x = e(this).data(b), w = e(this), C = w.find(v.icon);
            d = {
                initialize: function () {
                    ...
                    mouseenter: function () {
                        ...
                        var t = e(this), n = d.getRating(), i = C.index(t) + 1, o = "auto" == m.clearable ? 1 === C.length : m.clearable;
    ...
    e.fn.search = function (o) {
        ...
        return e(this).each(function () {
            var f, g = e.extend(!0, {}, e.fn.search.settings, o), p = g.className, v = g.metadata, h = g.regExp, b = g.selector, y = g.error, x = g.namespace, w = "." + x, C = x + "-module", T = e(this), k = T.find(b.prompt), S = T.find(b.searchButton), A = T.find(b.results), P = (T.find(b.result), T.find(b.category), this), E = T.data(C);
            f = {
                initialize: function () {
                    ...
                    focus: function () {
                        ...
                        mousedown: function () {
                            ...
                            var i = e(this), o = i.find(b.title).eq(0), a = i.find("a[href]").eq(0), r = a.attr("href") || !1, s = a.attr("target") || !1, c = (o.html(), o.length > 0 ? o.text() : !1), l = f.get.results(), u = f.get.result(c, l);
                    ...
                    if (r == s.escape && (f.verbose("Escape key pressed, blurring search field"), k.trigger("blur")), f.is.visible())if (r == s.enter) {
                    ...
                    api: function () {
                        var e = {on: !1, action: "search", onFailure: f.error};
                    ...
                    local: function (e) {
                        ...
                        f.set.loading(), f.save.results(n), f.debug("Returned local search results", n), t = f.generateResults({results: n}), f.remove.loading(), f.write.cache(e, {
                            html: t,
                            results: n
                        }), f.addResults(t)
                    }, remote: function (t) {
    ...
    e.fn.shape = function (o) {
        ...
        return r.each(function () {
            var t, f, g, p = r.selector || "", v = e.extend(!0, {}, e.fn.shape.settings, o), h = v.namespace, b = v.selector, y = v.error, x = v.className, w = "." + h, C = "module-" + h, T = e(this), k = T.find(b.sides), S = T.find(b.side), A = !1, P = this, E = T.data(C);
            g = {
                initialize: function () {
    ...
    e.fn.sidebar = function (o) {
        ...
        return r.each(function () {
            var r, b, y, x, w, C, T = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings), k = T.selector, S = T.className, A = T.namespace, P = T.regExp, E = T.error, F = "." + A, R = "module-" + A, O = e(this), D = e(T.context), z = O.children(k.sidebar), q = D.children(k.fixed), j = D.children(k.pusher), N = this, I = O.data(R);
            C = {
                initialize: function () {
                    ...
                    if (t = e.isFunction(t) ? t : function () {
                        ...
                        if (C.refreshSidebars(), T.overlay && (C.error(E.overlay), T.transition = "overlay"), C.refresh(), C.othersActive())if (C.debug("Other sidebars currently visible"), T.exclusive) {
                    ...
                    t = e.isFunction(t) ? t : function () {
                    }, "scale down" == T.transition && C.scrollToTop(), C.set.transition(o), C.repaint(), n = function () {
                    ...
                    }, o[i] = n, C.debug("Using javascript to push context", o), C.set.visible(), C.set.transition(), C.set.animating(), T.dimPage && j.addClass(S.dimmed), D.css("position", "relative").animate(o, T.duration, T.easing, function () {
                        C.remove.animating(), C.bind.clickaway(), t.call(N)
                    })
                }, legacyPullPage: function (t) {
                    var n = 0, i = C.get.direction(), o = {};
                    n = n || O.width(), t = e.isFunction(t) ? t : function () {
                    }, o[i] = "0px", C.debug("Using javascript to pull context", o), C.unbind.clickaway(), C.set.animating(), C.remove.visible(), T.dimPage && !C.othersActive() && j.removeClass(S.dimmed), D.css("position", "relative").animate(o, T.duration, T.easing, function () {
            ...
            f = {
                initialize: function () {
                    ...
                    direction: function (e) {
                        ...
                        e = e || T.scrollTop();
                        var t, n = f.cache.element, i = f.cache.window, o = f.get.scrollChange(e), a = n.height - i.height + g.offset, t = f.get.currentElementScroll(), r = t + o;
                    ...
                    offset: function () {
                        ...
                        "HTML" === e || "body" == e ? C = x.offsetParent() : Math.abs(C.height() - f.cache.context.height) > 5 && (f.debug("Context has padding, specifying exact height for container", f.cache.context.height), C.css({height: f.cache.context.height}))
                    }, scroll: function (e) {
                    ...
                    var t = e || T.scrollTop(), n = f.cache, i = n.fits, o = n.element, a = n.window, r = n.context, s = f.is.bottom() && g.pushing ? g.bottomOffset : g.offset, e = {
                        top: t + s,
                        bottom: t + s + a.height
                    }, c = (f.get.direction(e.top), i ? 0 : f.get.elementScroll(e.top)), l = !i, u = 0 !== o.height;
                    ...
                    x.css({width: "", height: ""}), C.css({height: ""})
                }, setting: function (t, n) {
                    if (e.isPlainObject(t))e.extend(!0, g, t); else {
                        if (n === i)return g[t];
                        g[t] = n
            ...
            o = {
                initialize: function () {
                    ...
                    i = o.utilities.arrayToPath(l), e.each(l, function (t, a) {
                        var u, d, m, f, g = l.slice(0, t + 1), b = o.utilities.arrayToPath(g), y = o.is.tab(b), x = t + 1 == l.length, C = o.get.tabElement(b);
    ...
    e.fn.transition = function () {
        ...
        return a.each(function (t) {
            var f, g, p, v, h, b, y, x, w, C, T, k = e(this), S = this;
            T = {
                initialize: function () {
                    ...
                    var n, o = f.reverse === !0, r = "auto" == f.reverse && T.get.direction() == v.outward;
                    ...
                    transition: function (t) {
                        var n, o, a, r, s, c = k.attr("class"), l = k.prop("tagName"), u = f.animation, d = T.get.transitionExists(u);
                        if (d === i || t) {
                    ...
                    if (T.debug("Changing setting", t, n), e.isPlainObject(t))e.extend(!0, f, t); else {
                        if (n === i)return f[t];
                        f[t] = n
                    }
                }, internal: function (t, n) {
    ...
    e.fn.video = function (n) {
        ...
        return a.each(function () {
            var m, f = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.video.settings, n) : e.extend({}, e.fn.video.settings), g = f.selector, p = f.className, v = f.error, h = f.metadata, b = f.namespace, y = f.templates, x = "." + b, w = "module-" + b, C = (e(t), e(this)), T = C.find(g.placeholder), k = C.find(g.playButton), S = C.find(g.embed), A = this, P = C.data(w);
            m = {
                initialize: function () {
    ...
    e.api = e.fn.api = function (n) {
        ...
        return a.each(function () {
            var t, a, m, f, g, p = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.api.settings, n) : e.extend({}, e.fn.api.settings), v = p.namespace, h = p.metadata, b = p.selector, y = p.error, x = p.className, w = "." + v, C = "module-" + v, T = e(this), k = T.closest(b.form), S = p.stateContext ? e(p.stateContext) : T, A = this, P = S.get(), E = T.data(C);
            g = {
                initialize: function () {
                    var e = g.get.event();
    ...
    e.fn.state = function (t) {
        ...
        return a.each(function () {
            var n, m = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.state.settings, t) : e.extend({}, e.fn.state.settings), f = m.error, g = m.metadata, p = m.className, v = m.namespace, h = m.states, b = m.text, y = "." + v, x = v + "-module", w = e(this), C = this, T = w.data(x);
            n = {
                initialize: function () {
                    ...
                    state: function () {
                        ...
                        if (n.allows("active") && n.is.enabled()) {
                            if (n.refresh(), e.fn.api !== i)if (t = w.api("get request"), o = w.api("was cancelled"))n.debug("API Request cancelled by beforesend"), m.activateTest = function () {
                                return !1
        ...
        return r.each(function () {
            ...
            f = {
                initialize: function () {
                    ...
                    }), r.observe(S, {childList: !0, subtree: !0}), f.debug("Setting up mutation observer", r))
                }, bind: {
                    events: function () {
                        ...
                        var t = w.find("img"), i = t.length, o = i, a = 0, r = [], s = [], c = n.createElement("img"), l = function () {
                            a++, a >= i && (f.debug("Images finished loading inside element, refreshing position"), f.refresh())
                        };
                        if (i > 0)for (t.each(function () {
                    ...
                    cache: function () {
                        f.cache = {occurred: {}, screen: {}, element: {}}
                    }, image: function () {
                        var e = w.data("src");
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onPassing, o = "passing";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onTopVisible, o = "topVisible";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onBottomVisible, o = "bottomVisible";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onTopPassed, o = "topPassed";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onBottomPassed, o = "bottomPassed";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onPassingReverse, o = "passingReverse";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onTopVisibleReverse, o = "topVisibleReverse";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onBottomVisibleReverse, o = "bottomVisibleReverse";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onTopPassedReverse, o = "topPassedReverse";
                    ...
                    var t = f.get.elementCalculations(), n = e || g.onBottomPassedReverse, o = "bottomPassedReverse";
                    ...
                    var n = f.get.elementCalculations(), i = f.get.screenCalculations();
                    ...
                    calculations: function () {
                        ...
                        var e = f.cache.element, t = f.get.screenSize();
                        ...
                        var e = f.get.screenCalculations(), t = f.get.elementPosition();
                        ...
                        f.verbose("Saving window position"), f.cache.screen = {height: C.height()}
                    }, position: function () {
