...
<main id="Instellingen_Extern">
    ...
    <section id="Tabel">
        ...
        <section id="Filters_Extern">
            ...
            <input type="text" name="Filter_ebedrijf" id="Filter_ebedrijf" placeholder="Bedrijf"
                   onkeyup="bedrijfChangeext(this)"/>
            <i class="ui search icon"></i>
            <input type="text" name="Filter_eadres" id="Filter_eadres" placeholder="Adres"
                   onkeyup="adresChangeext(this)"/>
            <i class="ui search icon"></i>
            <input type="text" name="Filter_etel" id="Filter_etel" placeholder="Telefoon" onkeyup="telChangeext(this)"/>
            <i class="ui search icon"></i>
            <input type="text" name="Filter_eemail" id="Filter_eemail" placeholder="E-mail"
                   onkeyup="emailChangeext(this)"/>
            <i class="ui search icon"></i>
        </section>
...
function dosomething(eml) {
    ...
    option1.appendChild(document.createTextNode("Basic"));
    option1.value = "Basic";
    var option2 = document.createElement("option");
    option2.appendChild(document.createTextNode("Onthaal"));
    option2.value = "Onthaal";
    var option3 = document.createElement("option");
    option3.appendChild(document.createTextNode("Admin"));
    option3.value = "Admin";
    var option4 = document.createElement("option");
    option4.appendChild(document.createTextNode("Werkman"));
    option4.value = "Werkman";
