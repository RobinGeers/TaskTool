...
<main id="Instellingen_Overzicht">
    ...
    <div><a id="first" href="../Instellingen_Interne_Werknemers/index.php"><i class="ui users icon"></i>

            <p>Interne werknemers</p></a></div>
    <div><a id="second" href="../Instellingen_Externe_Werknemers/index.php"><i class="ui shipping icon"></i>

            <p>Onderaannemers</p></a></div>
    <div><a id="third" href="../Instellingen_Lokalen/index.php"><i class="ui university icon"></i>
